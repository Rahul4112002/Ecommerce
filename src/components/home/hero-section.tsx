  ...
  return (
    <section className="relative">
      ...
      <div className="relative bg-black overflow-hidden min-h-[500px] sm:min-h-[550px] md:min-h-[650px] lg:min-h-[700px]">
        {/* Video Background - aggressively scaled to fill entire container */}
        <video
          autoPlay
          loop
          muted
        ...
        {/* Watermark cover - subtle gradient that blends with video */}
        <div className="absolute bottom-0 right-0 w-24 h-14 sm:w-28 sm:h-12 bg-gradient-to-tl from-black/80 via-black/40 to-transparent z-[1]" />
